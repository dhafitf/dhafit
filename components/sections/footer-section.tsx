...
export default function Footer() {
  ...
  return (
    <footer className='border-border mx-auto max-w-7xl flex justify-between max-sm:flex-col-reverse items-center gap-x-10 gap-y-4 border-y px-6 md:px-12 py-7 w-full'>
      ...
      <div className='flex flex-col items-end gap-4 sm:gap-2 max-xs:items-center'>
        {email && (
          <a
            href={`mailto:${email}`}
            className='text-foreground text-sm font-medium tracking-[-0.01em] no-underline'>
            {email}
          </a>
        )}
